  ...
  Widget build(BuildContext context) {
    return ThemeProvider(
      builder: (BuildContext context, ThemeData themeData) => Scaffold(
        appBar: AppBar(title: Text(widget.groupStation.groupStationName.zhTw)),
        body: Column(
          children: [
            Wrap(
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: () => setState(() {
                          isStationSelected[entry.key] =
                              !isStationSelected[entry.key]!;
                          for (String stationUid in widget.stations.keys) {
                            for (String stopUid
            ...
            Wrap(
                ...
                children: () {
                  List<Widget> widgets = [];
                  widget.stops
                      .forEach((String stationUid, BusStopsType busStops) {
                        ...
                        Container(
                          ...
                          child: OutlinedButton(
                            style: OutlinedButton.styleFrom(
                              ...
                              backgroundColor: isStopSelected[busStopUid]!
                                  ? themeData.colorScheme.primary
                                  : null,
                            ),
                            onPressed: () => setState(() =>
                ...
                builder: (BuildContext context) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      BusRoute busRoute =
                          Util.getBusRoute(routeStopsList[index].routeUid)!;
                      return ListTile(
                        title: Text(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            EstimatedTimeText(
                              ...
                              direction: routeStopsList[index].direction,
                              stopUid:
                                  routeStopsList[index].stops.first.stopUid,
                            ...
                            FavoriteStopButton(
                                ...
                                stopUid:
                                    routeStopsList[index].stops.first.stopUid,
                                setState: setState),
                            RoutePopupMenuButton(routeUid: busRoute.routeUid),
                          ],
                        ),
                      );
                    },
